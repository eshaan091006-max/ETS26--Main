...
import 'package:malhar_ets/app/admin/contingent/contingent_management_page.dart';
import 'package:malhar_ets/app/admin/event/event_management_page.dart';
...
class Main extends StatefulWidget {
  ...
  const Main({required this.isVolunteer, super.key});
    ...
    List<VoidCallback> actionList = [
      ...
      () => showEventModal(
        ...
        onSubmit: (Event e, List<FormLink> links) async {
          int? eventId = await EventController().createEvent(context, e);
          if (eventId != null && links.isNotEmpty) {
